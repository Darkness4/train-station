...
public object GetOneStationResponseKt {
  ...
  @kotlin.PublishedApi
    ...
    public var station: com.example.trainstationapp.data.grpc.trainstation.v1alpha1.StationProto.Station
      @kotlin.jvm.JvmName("getStation")
        get() = _builder.station
      @kotlin.jvm.JvmName("setStation")
        set(value) {
    ...
    public val GetOneStationResponseKt.Dsl.stationOrNull: com.example.trainstationapp.data.grpc.trainstation.v1alpha1.StationProto.Station?
