...
public object GetManyStationsResponseKt {
  ...
  @kotlin.PublishedApi
    ...
    public var stations: com.example.trainstationapp.data.grpc.trainstation.v1alpha1.StationProto.PaginatedStation
      @kotlin.jvm.JvmName("getStations")
        get() = _builder.stations
      @kotlin.jvm.JvmName("setStations")
        set(value) {
        _builder.stations = value
      }
    /**
     * `.trainstation.v1alpha1.PaginatedStation stations = 1 [json_name = "stations"];`
     */
    ...
    public val GetManyStationsResponseKt.Dsl.stationsOrNull: com.example.trainstationapp.data.grpc.trainstation.v1alpha1.StationProto.PaginatedStation?
      get() = _builder.stationsOrNull
  }
}
